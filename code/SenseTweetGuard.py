...
model.compile(optimizer=Adam(0.0001),loss={'task_stance_specific':'categorical_crossentropy','task_topic_specific':'categorical_crossentropy',
    ...
    loss_weights={'task_stance_specific':1.0,'task_topic_specific':1.0,'task_hate_specific':0.01,'task_sent_specific':0.01,'task_stance_shared':1.0,'task_topic_shared':1.0,'task_hate_shared':0.01,'task_sent_shared':0.01,'task_adv_stance':1.0,'task_adv_topic':1.0,'task_adv_hate':0.01,'task_adv_sent':0.01}, metrics=['accuracy'])    
print(model.summary())
